      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-gray-600 text-sm mt-1">
            Empresas contratantes, matrículas empresariais, turmas corporativas e resultado acadêmico
          </p>
        </div>

        <Tabs defaultValue="resumo">
          <TabsList className="grid w-full grid-cols-3 mb-6 bg-gray-100 p-1 h-auto">
            <TabsTrigger value="resumo" className="flex items-center gap-2 data-[state=active]:bg-blue-700 data-[state=active]:text-white py-3">
