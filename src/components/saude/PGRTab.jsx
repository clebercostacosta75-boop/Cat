...
export default function PGRTab() {
  ...
  const remove = async (id) => {
    ...
    await base44.entities.DocumentoPGR.delete(id);
    load();
  };
                      ...
                      <div className="flex gap-1 justify-end">
                        {r.arquivo_pdf && (
                          <a href={r.arquivo_pdf} target="_blank" rel="noreferrer">
                            <Button size="icon" variant="ghost" title="Ver PDF"><FileText className="w-4 h-4 text-blue-500" /></Button>
                          </a>
                        )}
            ...
            <>
              ...
              <div className="grid gap-3 py-1">
                {[
                  ...
                  ["Nº de Funcionários", "numero_funcionarios", "number"],
                ].map(([label, key, type]) => (
                  <div key={key}>
